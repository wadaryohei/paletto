...
import { initValue, validationSchema } from '@/datas/ValidationDatas'
...
// component
//----------------------------------
export const Index = (componentProps: Props) => {
  ...
  return (
    ...
    >
      {(props) => {
        return (
          <Form name="contact" className={componentProps.className}>
            <ul>
